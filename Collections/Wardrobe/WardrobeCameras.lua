-- Камеры для моделей «Внешнего вида»: таблицы WCollections (Camera.lua) по расе, полу и типу предмета.
-- Значения: { x (приближение), y (влево/вправо), z (вверх/вниз), поворот, [анимация] }.
-- Ниже - обвязка, чтобы файл работал без аддона WCollections.

WCollections = WCollections or {};
WCollections.Config = WCollections.Config or { Wardrobe = { CameraOption = "Classic" } };
WCollections.Cache = WCollections.Cache or { Cameras = {} };
PI = PI or math.pi;

-- подклассы оружия 3.3.5 (в ретейле - LE_ITEM_WEAPON_*)
LE_ITEM_WEAPON_AXE1H = LE_ITEM_WEAPON_AXE1H or 0;
LE_ITEM_WEAPON_AXE2H = LE_ITEM_WEAPON_AXE2H or 1;
LE_ITEM_WEAPON_BOWS = LE_ITEM_WEAPON_BOWS or 2;
LE_ITEM_WEAPON_GUNS = LE_ITEM_WEAPON_GUNS or 3;
LE_ITEM_WEAPON_MACE1H = LE_ITEM_WEAPON_MACE1H or 4;
LE_ITEM_WEAPON_MACE2H = LE_ITEM_WEAPON_MACE2H or 5;
LE_ITEM_WEAPON_POLEARM = LE_ITEM_WEAPON_POLEARM or 6;
LE_ITEM_WEAPON_SWORD1H = LE_ITEM_WEAPON_SWORD1H or 7;
LE_ITEM_WEAPON_SWORD2H = LE_ITEM_WEAPON_SWORD2H or 8;
LE_ITEM_WEAPON_STAFF = LE_ITEM_WEAPON_STAFF or 10;
LE_ITEM_WEAPON_FIST = LE_ITEM_WEAPON_FIST or 13;
LE_ITEM_WEAPON_GENERIC = LE_ITEM_WEAPON_GENERIC or 14;
LE_ITEM_WEAPON_DAGGER = LE_ITEM_WEAPON_DAGGER or 15;
LE_ITEM_WEAPON_THROWN = LE_ITEM_WEAPON_THROWN or 16;
LE_ITEM_WEAPON_CROSSBOW = LE_ITEM_WEAPON_CROSSBOW or 18;
LE_ITEM_WEAPON_WAND = LE_ITEM_WEAPON_WAND or 19;
LE_ITEM_WEAPON_FISHINGPOLE = LE_ITEM_WEAPON_FISHINGPOLE or 20;
